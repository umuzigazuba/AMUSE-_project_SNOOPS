...
tot_cloud_mass = 4/3 *units.constants.pi * ( 25 | units.pc)**3 * ( 2.3 | units.amu * 10 / (units.cm**3))
...
for i in range (len(velocity)):
    ...
    star_cluster,converter_cluster = utils.make_cluster_with_vinit(v,60,207349,1000)
