...
for i in range (len(velocity)):
    ...
    star_cluster,converter_cluster = utils.make_cluster_with_vinit(v,20,207349)
    ...
    if __name__ == "__main__":
        ...
        post_collision_cluster = utils.let_them_collide_and_save(directory_path,2,0.1,sinks,gravhydrobridge,channel,\
